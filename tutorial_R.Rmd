...
Important: before you import any data frame to R, you should set your working directory i.e. the folder where your data is saved. Not only that this is the folder where you save the data you need for analysis, but also this is the folder where your analysis results will be stored.
...
Data frame is essentially a collection of vectors. When you access a certain variable in your data frame (with the help of "\$" sign as given in the example below), you are essentially accessing a vector.
